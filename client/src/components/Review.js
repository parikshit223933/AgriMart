...
class Review extends React.Component
{
    ...
    render()
    {
        ...
        let likeColor=`${review.likes.includes(this.props.auth.user._id)?'#046fe4':'grey'}`;
        let dislikeColor=`${review.dislikes.includes(this.props.auth.user._id)?'#dc2943':'grey'}`;
        // #dc2943
