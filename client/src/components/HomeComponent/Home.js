...
import { HomeSingleCategory, Search } from "../";
				...
				<div className="container-fluid pl-0 pr-0 mb-5">
					...
					<div className="w-100 categ">
						...
						{!this.props.product.homeProducts ? (
							...
							<HomeSingleCategory
								products={
									this.props.product.homeProducts["Seeds"]
								}
							/>
						)}
					</div>
					<div className="w-100 categ">
						...
						{!this.props.product.homeProducts ? (
							...
							<HomeSingleCategory
								products={
									this.props.product.homeProducts["Spices"]
								}
							/>
						)}
					</div>
					<div className="w-100 categ">
						...
						{!this.props.product.homeProducts ? (
							...
							<HomeSingleCategory
								products={
									this.props.product.homeProducts["Fruits"]
								}
							/>
						)}
					</div>
					...
					<div className="w-100 categ">
						...
						{!this.props.product.homeProducts ? (
							...
							<HomeSingleCategory
								products={
									this.props.product.homeProducts["Other"]
								}
							/>
						)}
					</div>
